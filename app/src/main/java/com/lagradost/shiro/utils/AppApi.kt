...
class AppApi {
    companion object {
        ...
        fun Activity.setViewPosDur(data: PlayerData, pos: Long, dur: Long) {
        ...
        fun AppCompatActivity.popCurrentPage(isInPlayer: Boolean, isInExpandedView: Boolean, isInResults: Boolean) {
            println("POPP")
...
// except for the ones that make the content appear under the system bars.
        ...
        fun AppCompatActivity.loadPlayer(episodeIndex: Int, startAt: Long, card: ShiroApi.AnimePageData) {
            loadPlayer(
                PlayerData(
                    null, null,
                    episodeIndex,
        ...
        fun AppCompatActivity.loadPlayer(data: PlayerData) {
        ...
        fun AppCompatActivity.loadPage(card: ShiroApi.AnimePageData) {
            supportFragmentManager.beginTransaction()
                .setCustomAnimations(R.anim.enter, R.anim.exit, R.anim.pop_enter, R.anim.pop_exit)
    ...
    */
        ...
        fun Activity.shouldShowPIPMode(isInPlayer: Boolean): Boolean {
            val settingsManager = PreferenceManager.getDefaultSharedPreferences(this)
